...
export default function MobileMenu() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed right-0 top-0 z-50 h-screen w-80 max-w-[85vw] border-l border-border bg-background shadow-2xl transition-transform duration-300 ease-out lg:hidden ${
          isOpen ? "translate-x-0" : "translate-x-full"
        }`}
      >
        {/* Header */}
